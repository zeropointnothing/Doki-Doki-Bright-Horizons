...
label bg_test:
    ...
    s "This is a test for the park background."
    show sayori at thide
    hide sayori
    scene bg park_path with dissolve_scene_full
    show sayori 4n at l11 zorder 2
    s "This is the second test for the park background."
    $ renpy.quit()